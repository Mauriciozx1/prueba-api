                    ...
                    <div class="card-body">
                        ...
                        <form @submit.prevent="login" class="row">
                            ...
                            <div class="form-group col-12">
                                ...
                                <input type="text" v-model="auth.email" name="email" id="email" class="form-control" placeholder="Ingresa tu correo electronico"  required>
                                <small>Email test: demoprueba@test.cl</small>
                            </div>
                            <div class="form-group col-12 my-2">
                                <label for="password" class="font-weight-bold">Contraseña</label>
                                <input type="password" v-model="auth.password" name="password" id="password" class="form-control" placeholder="Ingresa tu contraseña" required>
